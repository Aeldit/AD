...
execute if data storage floating_texts:settings ft_settings{non_op_deco: "ON"} run tellraw @s [{"text":"Non OP decoration: ","color":"aqua"},{"storage":"floating_texts:settings", "nbt":"ft_settings.non_op_deco", "color":"green", "clickEvent":{"action":"run_command", "value":"/function floating_texts:settings/allow_non_op_decorations"}, "hoverEvent":{"action":"show_text", "contents":{"text":"Click to toggle", "color":"yellow"}}}]
execute if data storage floating_texts:settings ft_settings{non_op_deco: "OFF"} run tellraw @s [{"text":"Non OP decoration: ","color":"aqua"},{"storage":"floating_texts:settings", "nbt":"ft_settings.non_op_deco", "color":"red", "clickEvent":{"action":"run_command", "value":"/function floating_texts:settings/allow_non_op_decorations"}, "hoverEvent":{"action":"show_text", "contents":{"text":"Click to toggle", "color":"yellow"}}}]
