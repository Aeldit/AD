...
![dowload_FT][def__download_AD]

## How to use

Rename a name tag and click with it on an armor stand (the name doesn't appear at first). Then, use the book to select the color / decoration you want to apply to the text. To obtain the book, sign a book and quil with 'FT'

> Here is the book with the different options
